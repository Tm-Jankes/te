...
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "EITHON")
SUDO_USERS = list(map(int, getenv("SUDO_USERS").split()))
COMMAND_PREFIXES = list(getenv("COMMAND_PREFIXES", "ف ب غ ب ش س ك و م ا ت / ! .").split())
ALIVE_IMG = getenv("ALIVE_IMG", "hhttps://telegra.ph/file/aa0ad3671257edd1ddace.jpg")
...
IMG_3 = getenv("IMG_3", "https://telegra.ph/file/aa0ad3671257edd1ddace.jpgg")
